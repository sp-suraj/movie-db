  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      <p>
        ...
        Our movie database is constantly updated with new releases, ensuring
        that you have access to the latest and greatest in the world of cinema.
        You can search for movies by title, director, actor, genre, or release
      ...
      <p>
        ...
        for movie lovers to connect and share your thoughts on the latest
